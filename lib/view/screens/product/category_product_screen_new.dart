...
import 'package:seven/data/model/response/category_model.dart';
...
class CategoryProductScreenNew extends StatefulWidget {
  ...
  CategoryProductScreenNew(
      {Key? key, required this.categoryModel, this.subCategory})
      : super(key: key);
...
class _CategoryProductScreenNewState extends State<CategoryProductScreenNew> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.subCategory != null && widget.subCategory != 'null') {
      ...
      _appBarText = Provider.of<CategoryProvider>(context).categoryModel != null
                              ...
                              if (ResponsiveHelper.isDesktop(context))
                                PopupMenuButton(
                                    ...
                                    onSelected: (dynamic value) {
                                      int _index = Provider.of<ProductProvider>(
                                              context,
                                              listen: false)
                                          .allSortBy
                                          .indexOf(value);
                      ...
                      ? Container(
                          ...
                          child: GridView.builder(
                            gridDelegate:
                              ...
                              childAspectRatio:
                                  ResponsiveHelper.isDesktop(context) ? 0.7 : 3,
                              crossAxisCount:
