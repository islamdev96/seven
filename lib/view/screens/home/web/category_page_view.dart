...
import 'package:seven/view/base/on_hover.dart';
import 'package:seven/view/base/text_hover.dart';
          ...
          return Align(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, item) {
                  ...
                  String? _name = '';
                  categoryProvider.categoryList![_currentIndex].name!.length >
                          20
                      ? _name = categoryProvider
                              .categoryList![_currentIndex].name!
                              .substring(0, 20) +
                          ' ...'
                      : _name =
                          categoryProvider.categoryList![_currentIndex].name;
                  return Container(
