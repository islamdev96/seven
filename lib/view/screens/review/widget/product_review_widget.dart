...
import 'package:seven/data/model/body/review_body.dart';
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: FadeInImage.assetNetwork(
                                      ...
                                      image:
                                          '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.productImageUrl}/${orderDetailsList[index].productDetails!.image!.isNotEmpty ? orderDetailsList[index].productDetails!.image![0] : ''}',
                                      height: 70,
                                      width: 85,
                                      fit: BoxFit.cover,
