...
import 'package:seven/view/screens/cart/widget/cart_product_widget.dart';
import 'package:seven/view/screens/cart/widget/delivery_option_button.dart';
import 'package:seven/view/screens/checkout/checkout_screen.dart';
                                ...
                                onPressed: () {
                                  if (_itemPrice <
                                      Provider.of<SplashProvider>(context,
                                          ...
                                          .minimumOrderValue!) {
                                    showCustomSnackBar(
                                        '${getTranslated('minimum_order_amount_is', context)}${PriceConverter.convertPrice(context, Provider.of<SplashProvider>(context, listen: false).configModel!.minimumOrderValue)},${getTranslated('you_have', context)} ${PriceConverter.convertPrice(context, _itemPrice)} ${getTranslated('in_your_cart_please_add_more_item', context)}',
                                        context,
                                        isError: true);
                                  } else {
                                    String? _orderType =
