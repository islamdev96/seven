...
import 'package:seven/helper/notification_helper.dart';
...
import 'package:seven/view/screens/chat/widget/message_bubble.dart';
import 'package:seven/view/screens/chat/widget/message_bubble_shimmer.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    if (!kIsWeb) {
      ...
      FirebaseMessaging.onMessage.listen((RemoteMessage message) {
        ...
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(context, 1, widget.orderModel, false);
      });
    ...
    if (_isLoggedIn) {
      if (_isFirst) {
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(context, 1, widget.orderModel, true);
      } else {
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(context, 1, widget.orderModel, false);
        _isFirst = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)
          ...
          : ResponsiveHelper.isMobilePhone() && _isAdmin
              ? null
              : AppBar(
                  title: _isAdmin
                      ? Text(
                          '${Provider.of<SplashProvider>(context, listen: false).configModel!.ecommerceName}')
                      : Text(widget.orderModel!.deliveryMan!.fName! +
                          ' ' +
                          widget.orderModel!.deliveryMan!.lName!),
                                ...
                                ? Container(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        return chatProvider.chatImage!.length >
                                                0
                                            ? Padding(
                                                padding:
