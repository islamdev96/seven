...
import 'package:seven/view/base/custom_dialog.dart';
import 'package:seven/view/base/main_app_bar.dart';
import 'package:seven/view/screens/settings/widget/currency_dialog.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isMobilePhone()
          ? null
          : (ResponsiveHelper.isDesktop(context) ? MainAppBar() : AppBarBase())
