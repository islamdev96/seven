...
import 'package:seven/data/model/response/delivery_man_model.dart';
import 'package:seven/data/model/response/distance_model.dart';
...
class OrderProvider extends ChangeNotifier {
  ...
  Future<void> setPlaceOrder(String placeOrder) async {
    await sharedPreferences!
        .setString(AppConstants.PLACE_ORDER_DATA, placeOrder);
  }
